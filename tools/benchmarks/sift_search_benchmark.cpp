...
struct Args {
  ...
  fs::path index_path = "indexes/sift1m_vamana_pq100_p4096_sm.idx";
...
void print_help() {
  std::cout
      ...
      << "  --prefetch-width N           Frontier/next-hop prefetch width, default 4\n"
...
SearchAggregate run_search_worker(const Args& args,
  ...
  const auto search = make_search_config(args, pq_model, entry_seed_ids);
