...
struct DiskGraphSearchStats {
  ...
  std::size_t prefetch_completed = 0;
  std::size_t prefetch_ready_hit = 0;
  std::size_t prefetch_pending_hit = 0;
  std::size_t prefetch_late_hit = 0;
  std::size_t prefetch_dropped = 0;
  std::size_t prefetch_promoted = 0;
  std::size_t prefetch_cache_pollution_avoided = 0;
  std::size_t demand_priority_blocks_prefetch = 0;
  std::size_t prefetch_skip_seen_before = 0;
  std::size_t prefetch_skip_cached = 0;
  std::size_t prefetch_skip_pending = 0;
