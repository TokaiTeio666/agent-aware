...
| 编号 | 建议时间 | 核心目标 | 交付物 |
|---|---:|---|---|
| 02 缓存与零拷贝 | 第 3–4 周 | 完成 Graph-Aware 2Q 缓存、pin/unpin、compute_distance_direct | 缓存命中率对比、线程安全验证、性能对比报告 |
...
因此，本设计的核心思路是：**让缓存理解图结构，让距离计算尽量贴近 page 原始数据，让并发访问保持正确性。**
...
docs/design/02-cache-zero-copy.md
```
